...
const DEFAULT_GLOW_COLOR = '94, 106, 210'; // Primary color RGB
...
export function ParticleCard({
  ...
  }, [animateParticles, clearAllParticles, enableTilt, enableGlow, clickEffect, glowColor]);

  return (
    <div ref={cardRef} className={`magic-card ${className}`} style={style}>
      {children}
    </div>
  );
}
